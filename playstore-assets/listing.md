...
## Production release notes (for the v0.2.2 AAB upload)

Version: `0.2.2` · Version code: `18`
...
- [x] Current AAB staged: `playstore-assets/OmniTAK-0.2.2-vc18.aab`
...
- [ ] Upload `OmniTAK-0.2.2-vc18.aab` to Closed testing → Create new release
